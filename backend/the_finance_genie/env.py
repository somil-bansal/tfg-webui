...
WEBUI_FAVICON_URL = "https://the-finance-genie.com/favicon.png"
...
if FROM_INIT_PY:
    PACKAGE_DATA = {"version": importlib.metadata.version("the-finance-genie")}
else:
    try:
...
try:
    ...
    changelog_content = (pkgutil.get_data("the_finance_genie", "CHANGELOG.md") or b"").decode()
...
OTEL_SERVICE_NAME = os.environ.get("OTEL_SERVICE_NAME", "the-finance-genie")
