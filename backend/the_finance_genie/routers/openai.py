...
from the_finance_genie.env import ENV, SRC_LOG_LEVELS


from the_finance_genie.utils.payload import (
        ...
        async with aiohttp.ClientSession(timeout=timeout, trust_env=True) as session:
            async with session.get(
                ...
                headers={
                    ...
                    **(
                        {
                            "X-TheFinanceGenie-User-Name": user.name,
                            "X-TheFinanceGenie-User-Id": user.id,
                            "X-TheFinanceGenie-User-Email": user.email,
                            "X-TheFinanceGenie-User-Role": user.role,
                        }
    ...
    if url_idx is None:
        ...
        async with aiohttp.ClientSession(
            ...
            try:
                ...
                raise HTTPException(
                    status_code=500, detail="The Finance Genie: Server Connection Error"
                )
            except Exception as e:
    ...
    try:
        ...
        r = await session.request(
            ...
            headers={
                ...
                **(
                    {
                        "HTTP-Referer": "https://the-finance-genie.com/",
                        "X-Title": "The Finance Genie",
                    }
        ...
        raise HTTPException(
            ...
            detail=detail if detail else "The Finance Genie: Server Connection Error",
        )
    finally:
