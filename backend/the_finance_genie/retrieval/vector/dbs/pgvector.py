...
from the_finance_genie.retrieval.vector.main import VectorItem, SearchResult, GetResult
from the_finance_genie.config import PGVECTOR_DB_URL, PGVECTOR_INITIALIZE_MAX_VECTOR_LENGTH
...
class PgvectorClient:
    def __init__(self) -> None:
        ...
        if not PGVECTOR_DB_URL:
            from the_finance_genie.internal.db import Session
