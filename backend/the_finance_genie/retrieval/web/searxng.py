...
import requests
from the_finance_genie.retrieval.web.main import SearchResult, get_filtered_results
...
def search_searxng(
    ...
    **kwargs,
    ...
    response = requests.get(
        query_url,
        headers={
            "User-Agent": "The Finance Genie (https://github.com/the-finance-genie/the-finance-genie) RAG Bot",
            "Accept": "text/html",
