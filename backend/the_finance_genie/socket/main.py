...
from the_finance_genie.models.channels import Channels
from the_finance_genie.models.chats import Chats
from the_finance_genie.utils.redis import (
...
from the_finance_genie.utils.auth import decode_token
from the_finance_genie.socket.utils import RedisDict, RedisLock
...
if WEBSOCKET_MANAGER == "redis":
    ...
    SESSION_POOL = RedisDict(
        "the-finance-genie:session_pool",
        redis_url=WEBSOCKET_REDIS_URL,
        redis_sentinels=redis_sentinels,
    )
    USER_POOL = RedisDict(
        "the-finance-genie:user_pool",
        redis_url=WEBSOCKET_REDIS_URL,
        redis_sentinels=redis_sentinels,
    )
    USAGE_POOL = RedisDict(
        "the-finance-genie:usage_pool",
        redis_url=WEBSOCKET_REDIS_URL,
        redis_sentinels=redis_sentinels,
    )
