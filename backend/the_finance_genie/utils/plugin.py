...
from the_finance_genie.env import SRC_LOG_LEVELS, PIP_OPTIONS, PIP_PACKAGE_INDEX_OPTIONS
from the_finance_genie.models.functions import Functions
from the_finance_genie.models.tools import Tools
...
def replace_imports(content):
    ...
    """
    replacements = {
        "from utils": "from the_finance_genie.utils",
        "from apps": "from the_finance_genie.apps",
        "from main": "from the_finance_genie.main",
        "from config": "from the_finance_genie.config",
    }
