...
from the_finance_genie.models.users import Users
from the_finance_genie.socket.main import (
    get_event_call,
    get_event_emitter,
    get_active_status_by_user_id,
)
from the_finance_genie.routers.tasks import (
    generate_queries,
    generate_title,
    generate_chat_tags,
)
from the_finance_genie.routers.retrieval import process_web_search, SearchForm
from the_finance_genie.routers.pipelines import (
    process_pipeline_inlet_filter,
    process_pipeline_outlet_filter,
)

from the_finance_genie.models.users import UserModel
from the_finance_genie.models.functions import Functions
from the_finance_genie.models.models import Models

from the_finance_genie.retrieval.utils import get_sources_from_files

from the_finance_genie.utils.chat import generate_chat_completion
from the_finance_genie.utils.task import (
    get_task_model_id,
    rag_template,
...
from the_finance_genie.utils.tools import get_tools
from the_finance_genie.utils.plugin import load_function_module_by_id
from the_finance_genie.utils.filter import (
    get_sorted_filter_ids,
    process_filter_functions,
)

from the_finance_genie.tasks import create_task
...
from the_finance_genie.constants import TASKS
...
async def process_chat_response(
    ...
    if event_emitter and event_caller:
        ...
        async def post_response_handler(response, events):
            ...
            content_blocks = []  # Initialize content_blocks
