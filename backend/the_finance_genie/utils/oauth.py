...
from the_finance_genie.models.auths import Auths
from the_finance_genie.models.users import Users
from the_finance_genie.models.groups import Groups, GroupModel, GroupUpdateForm
...
from the_finance_genie.utils.misc import parse_duration
from the_finance_genie.utils.auth import get_password_hash, create_token
...
class OAuthManager:
    ...
    def update_user_groups(self, user, user_data, default_permissions):
        ...
        log.debug(
            f"All groups available in TheFinanceGenie: {[g.name for g in all_available_groups]}"
        )
