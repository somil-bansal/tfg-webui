...
{#if taskConfig}
	...
	>
		<div class="  overflow-y-scroll scrollbar-hidden h-full pr-1.5">
			<div class="mb-3.5">
				<div class=" mb-2.5 text-base font-medium">{'Tasks'}</div>

				<hr class=" border-gray-100 dark:border-gray-850 my-2" />

				<div class=" mb-1 font-medium flex items-center">
					<div class=" text-xs mr-1">{'Set Task Model'}</div>
					<Tooltip
						content={'Select a model to use for task generation'}
					>
						<svg
					...
					<div class="mb-2.5">
						...
						>
							<Textarea
								...
								placeholder={'Enter a custom prompt for title generation'}
							/>
						</Tooltip>
					</div>
				{/if}
					...
					<div class="mb-2.5">
						...
						>
							<Textarea
								...
								placeholder={'Enter a custom prompt for tags generation'}
							/>
						</Tooltip>
					</div>
				{/if}
				...
				<div class="mb-2.5">
					...
					>
						<Textarea
							...
							placeholder={'Enter a custom prompt for query generation'}
						/>
					</Tooltip>
				</div>
			...
			<div class="mb-3.5">
				<div class=" mb-2.5 text-base font-medium">{'UI'}</div>
