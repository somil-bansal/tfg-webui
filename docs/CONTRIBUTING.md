...
Noticed something off? Have an idea? Check our [Issues tab](https://github.com/the-finance-genie/the-finance-genie/issues) to see if it's already been reported or suggested. If not, feel free to open a new issue. When reporting an issue, please follow our issue templates. These templates are designed to ensure that all necessary details are provided from the start, enabling us to address your concerns more efficiently.
...
1. Open a discussion regarding your ideas [here](https://github.com/the-finance-genie/the-finance-genie/discussions/new/choose).
